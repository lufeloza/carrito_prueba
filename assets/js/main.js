...
function eventListenersLoader() {
    ...
    document.addEventListener("DOMContentLoaded", ()=>{
        // si el local storage tiene info, entonces, igualamos carProducts
        // con la info del localStorage, pero si el localstorage
        // esta vacio entonces carproducts es un array vacio
...
// El local Storage
// es una base de datos del navegado que nos permite almacenar
// informacion para hacerla recurrente dentro de nuestra pagina
//  guardando informaciòn  en el local storage
// localStorage.setItem("name", "Fernando")

// Obtener informaciòn desde el local storage
// localStorage.getItem("name")

// const user = {name: "Fernando", lastName: "Lopez"}
//  convertir el objeto user en un JSON
// localStorage.setItem("user", JSON.stringify(user))
// Obtener la informacion y convertirla de JSON a Js
